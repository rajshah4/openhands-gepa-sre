...
Regression coverage for KAN-24: a pending pet (Nova) must never appear in the
available/adoptable catalog, and customers must not be able to start adoption
flows for pets not yet available. The filter must exclude any pet whose status
is not "available" (pending or adopted).
"""
